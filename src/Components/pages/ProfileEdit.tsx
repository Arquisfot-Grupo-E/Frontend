        ...
        <form onSubmit={onSubmit} className="grid gap-5">
          ...
          <div>
            ...
            <input
              ...
              value={form.email}
              disabled
              className="w-full px-3 py-2 rounded-lg border bg-gray-100 text-gray-500 cursor-not-allowed"
            />
          </div>
          ...
          <div className="flex gap-3 justify-end pt-2">
            <button
              ...
              className="px-4 py-2 rounded-lg bg-[var(--card-bg-color)] text-[var(--accent-color)] hover:bg-[var(--card-border-color)] transition shadow-sm"
            >
              Volver
            </button>
            <button
